...
import { Home, LayoutDashboard, FileText, Database, Contact, Cuboid as Cube, LineChart, PieChart, Brain, MessageSquareMore } from 'lucide-react';
...
const navItems = [
  ...
  { id: 'chat', label: 'AI Chat', icon: <MessageSquareMore className="w-5 h-5" />, to: '/chat' },
